...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of OV7670_VGA_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins OV7670_VGA_0/OV7670_VGA_AXI]
	connect_bd_net [get_bd_pins OV7670_VGA_0/ov7670_vga_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins OV7670_VGA_0/ov7670_vga_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to OV7670_VGA_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/OV7670_VGA_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_OV7670_VGA_0_OV7670_VGA_AXI_* ]]
	puts $fp "set ov7670_vga_axi_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/OV7670_VGA_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "OV7670_VGA_v1_0_hw_${i}"
